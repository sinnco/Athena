...
namespace ViData.ExpressionEval
{
    internal class ConditionBuilder : ExpressionVisitor
    {
        ...
        public DbProviderEx DbProEx { get; set; }
        ...
        protected override Expression VisitConstant(ConstantExpression c)
        {
            ...
            string wParam = String.Format("{2}wp{0}__{1}", this.m_arguments.Count - 1, LastColumn, DbProEx.ParameterType);
